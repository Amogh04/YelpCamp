...
let il = class ga extends S.Map {
  ...
  setStyle(t, n) {
    ...
    try {
      ...
      this.styleInProcess = !1, console.error("Error while setting style:", i);
    }
    return this;
  }
  /**
